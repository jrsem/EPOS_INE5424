...
struct Traits<Debug> : public Traits<void>
{
    ...
    //se "true" vai mostrar no terminal todos os passos executado do programa hello word a seu fim
...
template <>
struct Traits<Spin> : public Traits<void>
{
    static const bool debugged = hysterically_debugged;
};

template <>
struct Traits<Heaps> : public Traits<void>
{
    static const bool debugged = hysterically_debugged;
};

template <>
struct Traits<Observers> : public Traits<void>
{
...
template <>
struct Traits<Boot> : public Traits<void>
{
};

template <>
struct Traits<Setup> : public Traits<void>
{
};

template <>
struct Traits<Init> : public Traits<void>
{
};
...
// Components
template <>
struct Traits<Application> : public Traits<void>
{
...
struct Traits<System> : public Traits<void>
{
    ...
    static const bool multiheap = false; // true; é false pq o programa "hello worl usa só um thread" não precisa mais de um heap
...
template <>
struct Traits<Scheduler<Thread>> : public Traits<void>
{
    static const bool debugged = Traits<Thread>::trace_idle || hysterically_debugged;
};

template <>
struct Traits<Alarm> : public Traits<void>
{
    static const bool visible = hysterically_debugged;
};

template <>
struct Traits<Synchronizer> : public Traits<void>
{
